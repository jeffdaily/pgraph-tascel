 ...
 *------------------------------------------------------------*/
#pragma mta inline
void affine_gap_align(char *s1, int s1Len, char *s2, int s2Len, cell_t *result, cell_t **tbl, int **del, int **ins){
    int i, j;
    int cr, pr;
...
void printRow(cell_t **tbl, int i, int ncol){
    int j;
    printf("[");
    for(j = 0; j <= ncol; j++){
...
int is_edge(
        const cell_t result,
        char *s1, size_t s1Len, char *s2, size_t s2Len,
